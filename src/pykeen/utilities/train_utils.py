...
def create_neg_samples(pos_batch: np.ndarray, all_entities: np.ndarray) -> np.ndarray:
    """
    Create negative samples by "random sampling": replace subject or object of
    a positive sample by a random entity.
    """
    ...
    # Create negatives by replacing subjects
    ...
    # Create negatives by replacing objects
